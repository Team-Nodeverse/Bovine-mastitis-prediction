...
Healthy / Attention / High Risk
     ↓
16x4 LCD + Offline Storage
     ↓
Backend / Farmer Dashboard
```
...
| Component | Function |
|---|---|
| Raspberry Pi | Main edge-processing controller |
| ADS1115 | Analog sensor interface |
| pH Sensor | Milk pH measurement |
| EC Sensor | Electrical conductivity measurement |
| DS18B20 | Temperature measurement |
| Turbidity Sensor | Turbidity / optical-change input |
| 16x4 LCD | Local risk result display |
